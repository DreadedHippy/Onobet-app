...
const routes: Routes = [
  ...
  {
    path: 'signup',
    loadChildren: () => import('./authpages/signup/signup.module').then( m => m.SignupPageModule)
  },
  {
    path: 'login',
    ...
    path: 'bet-submit',
    loadChildren: () => import('./bet-submit/bet-submit.module').then( m => m.BetSubmitPageModule)
  }
